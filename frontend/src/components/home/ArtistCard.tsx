...
export function ArtistCard({ artist }: { artist: Artist }) {
  ...
  return (
    <Link
      ...
      className="block max-w-sm rounded-2xl border border-stone-200 bg-white p-6 shadow-sm transition hover:border-stone-300 hover:shadow-md"
    >
      <article>
        ...
        <span className="mt-6 inline-flex items-center justify-center rounded-lg bg-stone-900 px-4 py-2.5 text-sm text-white">
          View wishlist
        </span>
      </article>
    </Link>
